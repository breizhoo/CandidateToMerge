...
namespace WinFormsCandidateToMerge
{
    public partial class ChangeSetFormsOld : DockContent
    {
        ...
        public ChangeSetFormsOld(IDataSetManipulator dataSetManipulator, IServiceLocator serviceLocator)
        {
            _dataSetManipulator = dataSetManipulator;
            _changesetVisualizer = serviceLocator.GetInstance<IChangesetVisualizer>();
