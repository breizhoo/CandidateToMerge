...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class AutoHideStripSkin
    {
        ...
        {
            Color specialBlue = Color.FromArgb(0xFF, 0x00, 0x7A, 0xCC);

            m_dockStripGradient = new DockPanelGradient();
            m_dockStripGradient.StartColor = specialBlue;
    ...
    public class DockPaneStripSkin
    {
        ...
        public DockPaneStripSkin()
        {
            ...
            m_DocumentGradient.ActiveTabGradient.StartColor = specialBlue;
            m_DocumentGradient.ActiveTabGradient.EndColor = specialBlue;
            m_DocumentGradient.ActiveTabGradient.TextColor = Color.White;
            m_DocumentGradient.InactiveTabGradient.StartColor = SystemColors.Control;
            m_DocumentGradient.InactiveTabGradient.EndColor = SystemColors.InactiveCaption;
            m_DocumentGradient.InactiveTabGradient.TextColor = SystemColors.GrayText;

            m_ToolWindowGradient = new DockPaneStripToolWindowGradient();
            m_ToolWindowGradient.DockStripGradient.StartColor = SystemColors.Control;
            m_ToolWindowGradient.DockStripGradient.EndColor = SystemColors.Control;

            m_ToolWindowGradient.ActiveTabGradient.StartColor = SystemColors.ControlLightLight;
            m_ToolWindowGradient.ActiveTabGradient.EndColor = SystemColors.ControlLightLight;
            m_ToolWindowGradient.ActiveTabGradient.TextColor = specialBlue;
            

            m_ToolWindowGradient.InactiveTabGradient.StartColor = SystemColors.Control; //Color.Transparent;
            m_ToolWindowGradient.InactiveTabGradient.EndColor = SystemColors.Control; //Color.Transparent;
            m_ToolWindowGradient.InactiveTabGradient.TextColor = SystemColors.GrayText;

            m_ToolWindowGradient.ActiveCaptionGradient.StartColor = specialBlue;
            m_ToolWindowGradient.ActiveCaptionGradient.EndColor = Color.FromArgb(80, 170, 220); // dots in caption
            m_ToolWindowGradient.ActiveCaptionGradient.LinearGradientMode = LinearGradientMode.Vertical;
            m_ToolWindowGradient.ActiveCaptionGradient.TextColor = Color.White;

            m_ToolWindowGradient.InactiveCaptionGradient.StartColor = SystemColors.Control;
            m_ToolWindowGradient.InactiveCaptionGradient.EndColor = SystemColors.ControlDark;
            m_ToolWindowGradient.InactiveCaptionGradient.LinearGradientMode = LinearGradientMode.Vertical;
            m_ToolWindowGradient.InactiveCaptionGradient.TextColor = SystemColors.GrayText;
